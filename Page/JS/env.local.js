// Local environment override for client-side config.
// Edit the FIREBASE_CONFIG values below for your local/dev setup.
// This file should be included BEFORE firebase-init.js in pages that use Firebase.
window.__ENV = window.__ENV || {};
window.__ENV.FIREBASE_CONFIG = {
